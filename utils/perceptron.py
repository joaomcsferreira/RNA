...
class Perceptron:
    def __init__(self, rad, bias, num_epocas, operacao, gabarito, amostras, dominio_pesos) -> None:
        self.rad = rad
        self.bias = bias
    ...
    def somatorio(self, amostra) -> int:
        """
    ...
    def ajustar_peso(self, amostra, soma, gabarito) -> None:
        """
